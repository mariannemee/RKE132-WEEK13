...
{
    SQLiteConnection connection = new SQLiteConnection("Data Source=mydb.db = 3; New = True; Compress = True");
...
static void RemoveCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine($"{rowRemoverr} was removed from the table customer.");
